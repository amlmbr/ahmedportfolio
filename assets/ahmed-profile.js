...
window.AHMED_PROFILE = {
  ...
  experiences: [
    ...
    },
    {
      ...
      role: 'Research Internship — Deep Learning for Multimodal Time-Series Classification',
      project: 'NeurologiqueTWIN', target: 'projects',
      problem: 'How can heterogeneous EEG and IMU time-series be classified with deep learning to support neurological monitoring?',
  ...
  sections: [
    ...
    { id: 'exp-um6p', group: 'experience research', kw: 'um6p research multimodal eeg imu deep learning digital twin signals 2025 experience neurologiquetwin sdas when dates mohammed vi',
      text: 'UM6P — Smart Data Analysis Systems Research Group (Jul 2025 – Oct 2025) — Research internship whose core was DEEP LEARNING for multimodal time-series classification: Ahmed preprocessed, synchronized and segmented EEG + IMU signals and built the deep-learning classification models (CNN + attention). He then EXTENDED the project (NeurologiqueTWIN) by adding a Digital-Twin layer for monitoring and visualization. ≈92% internal accuracy; 6–10 pp pre-crisis recall improvement; 2nd Prize Innov\'Boost 2025.' },
    ...
    { id: 'proj-neurologiquetwin', group: 'projects', kw: 'neurologiquetwin multimodal digital twin eeg imu deep learning cnn attention pytorch signals classification um6p innovboost prize',
      text: 'NeurologiqueTWIN (UM6P, 2025). Internship CORE = Deep Learning for multimodal time-series classification: clean & synchronize EEG + IMU, segment/window, then a deep-learning classifier (PyTorch, CNN, attention). Ahmed\'s EXTENSION = a Digital-Twin layer to monitor, visualize and interpret the model outputs over time. ≈92% internal accuracy; 2nd Prize at Innov\'Boost 2025. Lesson: signal quality and temporal synchronization can matter as much as model complexity.' },
    ...
    { id: 'certifications', group: 'recognition', kw: 'certification certifications certified cloud data python courses stanford ibm aws oracle google mlops vertex generative security architecting',
      text: 'Certifications. Machine Learning & MLOps: Stanford Machine Learning Specialization; Google Cloud — MLOps with Vertex AI (Model Evaluation) and MLOps for Generative AI. Data Science: IBM Python for Data Science; IBM Data Science Methodology. Cloud: AWS Academy — Cloud Foundations, Cloud Architecting, Cloud Developing, Cloud Security Foundations and Cloud Security Builder (Lab Project); Oracle Cloud Infrastructure Foundations.' },
  ...
  faqs: [
    ...
    { id: 'um6p', keys: 'um6p multimodal eeg imu sdas digital twin extension deep learning part',
      a: 'At **UM6P** (SDAS Research Group, Jul–Oct 2025) the **core of Ahmed\'s internship was Deep Learning for multimodal time-series classification**: he cleaned, synchronized and segmented **EEG + IMU** signals and built the deep-learning classification models (CNN + attention). He then **extended** the project — **NeurologiqueTWIN** — by adding a **Digital-Twin layer** for monitoring and visualization. Result: ≈92% internal accuracy, 6–10 pp pre-crisis recall improvement, **2nd Prize Innov\'Boost 2025**.' },
    ...
    { id: 'deeplearning', keys: 'deep learning neural network cnn pytorch digital twin part neurologiquetwin classification',
      a: 'Yes. Ahmed\'s main **deep-learning** work was at **UM6P**: the internship core was **Deep Learning for multimodal EEG + IMU time-series classification** (CNN + attention, PyTorch) — that is the **NeurologiqueTWIN** model. He then **extended** it with a **Digital-Twin** layer for monitoring/visualization (the Digital Twin was his extension, not the core model). He also worked on **GEAR5** (distillation, quantization) and computer vision (**SwimCoach Vision**).' },
    ...
    { id: 'certs', keys: 'certifications certification certified courses stanford ibm aws oracle cloud google mlops vertex generative security architecting',
      a: 'Ahmed\'s **certifications** —\n**ML & MLOps:** Stanford Machine Learning Specialization · Google Cloud MLOps with Vertex AI (Model Evaluation) · Google Cloud MLOps for Generative AI.\n**Data Science:** IBM Python for Data Science · IBM Data Science Methodology.\n**Cloud:** AWS Academy Cloud Foundations, Cloud Architecting, Cloud Developing, Cloud Security Foundations, Cloud Security Builder (Lab) · Oracle Cloud Infrastructure Foundations.' },
